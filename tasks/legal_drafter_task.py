...
legal_drafter_task = Task(
    ...
    description=(
        ...
        "6. **Procedural Outlook** — Provide a detailed explanation of the bail status, punishment range, and fine estimates along with the legal reasoning as provided by the Procedural Law Expert.\n"
        "7. **Case Outcome Prediction** — Provide a detailed explanation of the probability of success, exploring the key strengths, weaknesses, and timeline in depth as provided by the Outcome Predictor.\n"
        "8. **Court-Ready Evidence Checklist** — What the user must collect.\n"
        "9. **Recommended Lawyer Type** — From the Matchmaker.\n"
        "10. **Relevant Precedents** — Include the detailed summaries and incident facts of the precedent cases exactly as provided by the Legal Precedent Agent. Do NOT just list their titles.\n"
